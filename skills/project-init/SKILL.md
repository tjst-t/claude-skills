...
2. Otherwise, call `sprint init` from the sprint-runner skill to set up a blank `docs/ROADMAP.md`.
3. If the sprint-runner skill is not available, create `docs/ROADMAP.md` manually with a blank template.

...
- `references/sprint-done-judgment.md` — **canonical 8-guard done judgment** (Guard 1–8) applied before any Story can be marked `done` (mirror of `../autopilot/references/autopilot-done-judgment.md`)
